    ...
    outline: [
      {
        title: 'Core Concepts',
        topics: [
          { title: 'Tokens & context', points: ['What tokens are', 'Why context windows matter', 'Prompt length tradeoffs'] },
          { title: 'Embeddings', points: ['What embeddings represent', 'Similarity search basics', 'Common use cases'] },
          { title: 'Prompting', points: ['Clear instructions', 'Constraints + format', 'Examples and edge cases'] },
        ],
      },
    ],
  },
    ...
    outline: [
      {
        title: 'RAG Pipeline',
        topics: [
          { title: 'Ingestion', points: ['Chunking strategies', 'Metadata design', 'Refresh & reindex cadence'] },
          { title: 'Retrieval', points: ['Vector search', 'Hybrid retrieval', 'Reranking (when/why)'] },
          { title: 'Generation', points: ['Answer with citations', 'Refusal handling', 'Guardrails'] },
        ],
      },
    ],
  },
    ...
    outline: [
      {
        title: 'Foundations',
        topics: [
          { title: 'Data mindset', points: ['Problem framing', 'Data collection', 'Bias & leakage awareness'] },
          { title: 'Spreadsheets → Python', points: ['Data types', 'Missing values', 'Basic aggregations'] },
          { title: 'Statistics basics', points: ['Distributions', 'Correlation vs causation', 'Confidence intervals'] },
        ],
      },
      {
        title: 'Analysis & Communication',
        topics: [
          { title: 'EDA', points: ['Sanity checks', 'Outliers', 'Feature exploration'] },
          { title: 'Visualization', points: ['Choosing charts', 'Avoiding misleading plots', 'Dashboards'] },
          { title: 'Storytelling', points: ['Narrative', 'Assumptions', 'Actionable recommendations'] },
        ],
      },
    ],
  },
    ...
    outline: [
      {
        ...
        topics: [
          { title: 'Threat landscape', points: ['Malware', 'Phishing', 'Credential stuffing'] },
          { title: 'Core controls', points: ['Least privilege', 'MFA', 'Logging and monitoring'] },
          { title: 'Network basics', points: ['DNS', 'HTTP(S)', 'Firewalls and segmentation'] },
        ],
      },
      {
        title: 'Operations',
        topics: [
          { title: 'Incident response', points: ['Triage', 'Containment', 'Lessons learned'] },
          { title: 'Vulnerability management', points: ['Scanning', 'Patching', 'Risk prioritization'] },
        ],
      },
    ],
  },
    ...
    outline: [
      {
        ...
        topics: [
          { title: 'CI/CD', points: ['Build pipelines', 'Tests and quality gates', 'Release strategies'] },
          { title: 'Containers', points: ['Images and registries', 'Runtime basics', '12-factor config'] },
          { title: 'Observability', points: ['Logs', 'Metrics', 'Tracing'] },
        ],
      },
      {
        title: 'Cloud',
        topics: [
          { title: 'Infrastructure as Code', points: ['Desired state', 'Safe rollouts', 'Drift detection'] },
          { title: 'Kubernetes basics', points: ['Pods/Deployments', 'Services/Ingress', 'ConfigMaps/Secrets'] },
        ],
      },
    ],
  },
    ...
    outline: [
      {
        title: 'Core ML',
        topics: [
          { title: 'Supervised learning', points: ['Features/labels', 'Train/val/test splits', 'Baseline models'] },
          { title: 'Evaluation', points: ['Accuracy vs F1', 'ROC-AUC', 'Cross-validation'] },
          { title: 'Iteration', points: ['Error analysis', 'Feature engineering', 'Regularization'] },
        ],
      },
      {
        title: 'Hands-on',
        topics: [
          { title: 'Data prep', points: ['Scaling', 'Encoding', 'Pipelines'] },
          { title: 'Deployment basics', points: ['Batch vs online', 'Monitoring drift', 'Rollback'] },
        ],
      },
    ],
  },
    ...
    outline: [
      {
        ...
        topics: [
          { title: 'Prompt patterns', points: ['Role/task/context', 'Few-shot examples', 'Structured output'] },
          { title: 'Tool use', points: ['Function calling mindset', 'Retries and validation', 'Rate limits'] },
          { title: 'Safety & evals', points: ['Policy checks', 'Regression evals', 'Human feedback loops'] },
        ],
      },
      {
        title: 'Systems',
        topics: [
          { title: 'RAG basics', points: ['Chunking', 'Retrieval', 'Citations and grounding'] },
          { title: 'Agents', points: ['Planning', 'Memory', 'Observability'] },
        ],
      },
    ],
  },
...
function ensureTenQuiz(params: {
  ...
  // Ensure ids are stable and unique (q1..q10).
